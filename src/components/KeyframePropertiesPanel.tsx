...
import { addStayHereKeyframe, removeStayHereKeyframe } from '../utils/keyframeUtils'
...
const KeyframePropertiesPanel: React.FC<KeyframePropertiesPanelProps> = ({
      ...
      if (kf.frame === selectedKeyframe) {
        return {
          ...
          animation: { 
            ...kf.animation,
            type,
            duration: kf.animation?.duration || 30
          }
        }
      }
      return kf
  ...
  const handleAddStayHere = () => {
    updateShape(addStayHereKeyframe(shape, selectedKeyframe))
  }

  const handleRemoveStayHere = () => {
    updateShape(removeStayHereKeyframe(shape, selectedKeyframe))
  }
    ...
    <div className="bg-white p-4 rounded-lg shadow-md">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between pt-4">
          <button
            onClick={handleAddStayHere}
            className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600"
          >
            Stay Here
          </button>
          <button
            onClick={handleRemoveStayHere}
